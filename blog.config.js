...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JackJame', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个苦逼的码农😘', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.qjit.com', // 网站地址
  ...
  WIDGET_PET_LINK: process.env.NEXT_PUBLIC_WIDGET_PET_LINK || 'https://cdn.jsdelivr.net/npm/live2d-widget-model-chitose@1.0.5/assets/chitose.physics.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
